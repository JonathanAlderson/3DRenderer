            ...
            if a != -1 and b != -1 and c != -1 and d != -1:
                if a[0]>0 and a[0]<windowWidth and  b[0]>0 and b[0]<windowWidth and c[0]>0 and c[0]<windowWidth and d[0]>0 and d[0]<windowWidth:
                    if a[1]>0 and a[1]<windowHeight and b[1]>0 and b[1]<windowHeight and c[1]>0 and c[1]<windowHeight and d[1]>0 and d[1]<windowHeight:
                        self.distancesAndFaces.append([distanceBetweenPoints(centerPoints(self.cubePoints[self.facesList[face][0]],self.cubePoints[self.facesList[face][1]],self.cubePoints[self.facesList[face][2]],self.cubePoints[self.facesList[face][3]]),[cameraX,cameraY,cameraZ]),[a,b,d,c],["orange","yellow","white","red","green","blue"][face]])
...
cubeArray.append(Cube(0,20,0,5))


cubeArray.append(Cube(30,20,0,2))
