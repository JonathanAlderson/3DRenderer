...
class Cube():
    ...
    def createFaces(self):
        #print("The errors begin here")
        #print(self.facesList)

        # self.cubeRenderPoints contains the x,y coordinates of all the vertexes in the cube
        
        for face in range(len(self.facesList)):
            #print(face)
             # a and a2 are the xy coordinates of the points in the psoigposigspgariojio
            ...
            if a != -1 and b != -1 and c != -1 and d != -1:
                if a[0]>0 and a[0]<windowWidth and  b[0]>0 and b[0]<windowWidth and c[0]>0 and c[0]<windowWidth and d[0]>0 and d[0]<windowWidth:
                    if a[1]>0 and a[1]<windowHeight and b[1]>0 and b[1]<windowHeight and c[1]>0 and c[1]<windowHeight and d[1]>0 and d[1]<windowHeight:
                        mycanvas.create_polygon(a,b,d,c,fill=["red","orange","blue","cyan","pink","purple"][face])
...
cubeArray.append(Cube(20,0,0,10))
cubeArray.append(Cube(20,20,0,10))
cubeArray.append(Cube(0,20,0,10))
